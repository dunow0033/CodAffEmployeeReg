...
namespace CodAffEmployeeRegisterAPI.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        {
            string imageName = new String(Path.GetFileNameWithoutExtension(imageFile.FileName).Take(10).ToArray().ToArray()).Replace(' ', '-');
